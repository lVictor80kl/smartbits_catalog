          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px', marginBottom: '6px' }}>
            ...
            <tbody>
              <tr style={{ borderBottom: '1px solid #e5e7eb' }}>
                ...
                <td style={{ padding: '10px', textAlign: 'right' }}>${formatMonto(component.precio ?? 0)}</td>
                <td style={{ padding: '10px', textAlign: 'right', fontWeight: '700' }}>${formatMonto(subtotal)}</td>
              </tr>
            </tbody>
          </table>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px', marginBottom: '20px' }}>
            ...
            <tbody>
              ...
              <tr style={{ borderTop: '2px solid #222' }}>
                ...
                <td style={{ padding: '10px', textAlign: 'right', fontWeight: '800', fontSize: '14px' }}>${formatMonto(subtotal)}</td>
              </tr>
            </tbody>
          </table>
